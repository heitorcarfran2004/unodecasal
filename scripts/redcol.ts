...
const ids=[1,5,9,13,17,21,25,29,33,37,41,45,49]; // every 4th = first of each block
const cols=ids.length, cardW=130, cardH=Math.round(cardW*1275/810), labelH=26, cellW=cardW+10, cellH=cardH+labelH;
let cells="";
ids.forEach((i,idx)=>{
...
writeFileSync("redcol.png",new Resvg(s,{fitTo:{mode:"width",value:W}}).render().asPng());
console.log("ok",W,H);
